!function r(e, n, t) {
    ...
    10: [ function(require, module, exports) {
        "use strict";
        var SubNav = require("./globals/modules/SubNav"), Helper = require("./globals/modules/Helper"), Emails = require("../_data/email-dummy-data/emails.json");
        !function() {
            var i, subscribeLink = document.getElementsByClassName("sub-link"), hash = window.location.hash, unsubDiv = document.getElementsByClassName("unsubscribe-div")[0], subnav = document.getElementsByTagName("nav")[0];
            for (subnav && (unsubDiv && "#unsubscribe" === hash ? (Helper.removeClass(unsubDiv, "hidden"), 
            ...
            function setResultText(index, result, good) {
                ...
                good ? Helper.addClass(subResults[i], "success") : Helper.removeClass(subResults[i], "success")) : (subResults[i].innerHTML = result, 
