!function r(e, n, t) {
    ...
    10: [ function(require, module, exports) {
        "use strict";
        var Helper = require("./globals/modules/Helper"), Emails = require("../_data/email-dummy-data/emails.json");
        !function() {
            ...
            function getEmailValue(index, unsub) {
                ...
                emailInput.length > index && (setResultText(index, "..."), function(index, emailAdd, unsub) {
                    var response = Emails;
                    if ("" === emailAdd) setResultText(index, "Please enter a valid email."); else for (var i = 0; i < response.length; ++i) {
                        var data = response[i];
                        if (data.email == emailAdd) {
                            console.log("step3"), !0, subSuccess(emailAdd), setResultText(index, "");
                            break;
                        }
                        console.log("failure");
                    }
            ...
            function subSuccess(emailAdd) {
                document.getElementById("success").innerHTML = 'The email you submitted:<br /><span class="email-span">' + emailAdd + "</span><br /> submitted is already subscribed to receive the Stand-To! email.";
            }
