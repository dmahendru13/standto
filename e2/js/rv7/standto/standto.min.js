!function r(e, n, t) {
    ...
    10: [ function(require, module, exports) {
        ...
        !function() {
            var i, subnav = document.getElementsByTagName("nav")[0], subscribeLink = document.getElementsByClassName("sub-link"), unsub = document.querySelector(".stand-to .focus"), hash = window.location.hash, unsubDiv = document.getElementsByClassName("unsubscribe-div")[0], socialbarwaypoint = document.getElementsByTagName("footer")[0];
            ...
            subscribeLink[i].onclick = function() {
                ...
                getEmailValue(this.getAttribute("data-email"));
            };
